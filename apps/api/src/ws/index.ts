...
const STT_URL = 'wss://api.deepgram.com/v1/listen?model=nova-2&language=en-GB&punctuate=true&smart_format=true&endpointing=200&utterance_end_ms=500&interim_results=true&encoding=linear16&sample_rate=16000&channels=1';
