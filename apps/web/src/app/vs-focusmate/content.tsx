...
export function VsFocusmateContent() {
  ...
  return (
    <>
      ...
      <SimplifiedSection
        ...
        summary="Focusmate uses accountability. Sit With You offers quiet presence."
      ...
      <SimplifiedSection
        heading="If you feel anxious on camera"
        summary="Built for people who want support without being watched."
        simplified={simplified}
      >
      ...
      <SimplifiedSection
        heading="Choose what your brain responds to"
        summary="Structure and reporting → Focusmate. Quiet company → Sit With You."
        simplified={simplified}
      >
        ...
        <p className="text-slate-300 leading-relaxed mb-6">
          ...
          Try Sit With You if you want calm presence without performance.
        </p>
        <p className="text-slate-300 leading-relaxed mb-6">
          Neither is wrong. Your nervous system gets a vote.
        </p>
        <p className="text-slate-400 text-sm mt-8">
          To understand the neurodivergent-first design, read about{' '}
          <a href="/neurodivergent-body-doubling" className="text-white/70 hover:text-white underline underline-offset-2">body doubling for neurodivergent minds</a>.
        </p>
      </SimplifiedSection>
    </>
  );
