...
export function FeelingOverwhelmedContent() {
  ...
  return (
    <>
      ...
      <SimplifiedSection
        heading="Overwhelm often needs company, not advice"
        summary="You don't have to perform or be coherent. Just arrive."
      ...
      <SimplifiedSection
        heading="A quiet reset"
        summary="Call, breathe, do one tiny thing."
        simplified={simplified}
      >
      ...
      <SimplifiedSection
        heading="If you want one tiny next step"
        summary="Say 'one step, please' and get a single small action."
        simplified={simplified}
      >
